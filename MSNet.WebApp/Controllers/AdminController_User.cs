...
namespace MSNet.WebApp.Controllers
{
    public partial class AdminController : AuthBaseController
    {
        ...
        //1：用户列表  2：权限列表 3：角色列表 4：角色权限 5：用户角色 
        ...
        public ActionResult AdminList()
        {
            ...
            //var exceptIds = new List<long> { (long)this.CurrentUser.PassportId };
            ...
            ViewData["UsersList"] = plist;
            return View();
        }
        #region AddUser
        public ActionResult AdminView()
        {
            var pId = Request["id"].ToLong();

            ViewData["Users"] = UserPassport.FindById(pId); 
        ...
        public ActionResult ModifyPassword()
        {
            ...
            {
                return Redirect("/pub/ErrorMsg?returnUrl=/admin/adminlist");      
            }
